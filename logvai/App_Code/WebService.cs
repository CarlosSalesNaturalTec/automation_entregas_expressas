...
/// </summary>
[WebService(Namespace = "http://logvaionline.azurewebsites.net")]
...
public class WebService : System.Web.Services.WebService
{
        ...
        string param6, string param7, string param8, string param9,string param10, string param11)
    {
        ...
        bool inserir = operacao.Insert("INSERT INTO Tbl_Usuarios (usuario,senha,cpfcnpj,nome,contato,endereco,numero," +
            "complemento,telefone,Cupom,dataCadastro,tipoPessoa) " +
        ...
        if (inserir == true)
        {
            ...
            while (dados.Read())
            {
                ...
                url = "SignIn_Confirm.aspx?v1=" + Convert.ToString(dados[2]);
            }
