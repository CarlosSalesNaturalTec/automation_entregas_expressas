...
public partial class EntregaAcompanhar : System.Web.UI.Page
{
    ...
    private void dadosCorpo()
    {
        ...
        while (dados.Read())
        {
            ...
            string bt2 = "<a class='" + classPag + "' onclick='" + codePagam +  "'><i class='fa fa-usd' aria-hidden='true'></i></a>";
            string bt3 = "<a class='" + classDelete + "' onclick='" + codeDelete + "'><i class='fa fa-trash-o' aria-hidden='true'></i></a>";
