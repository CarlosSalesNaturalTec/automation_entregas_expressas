<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PainelCliente2.aspx.cs" Inherits="PainelCliente2" %>
...
<body>
    ...
    <div>
        ...
        <div class="w3-container w3-padding-16 w3-light-grey">
            <iframe src="EntregaAcompanhar.aspx" width="100%" height="880" frameborder="0" name="iframe">Atualize seu Navegador!</iframe>
        </div>
    </div>
    <!-- page content -->
