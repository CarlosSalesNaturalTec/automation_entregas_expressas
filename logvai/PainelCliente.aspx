...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-light-grey w3-card-2" style="width: 15%">
        ...
        <section>
            <a href="EntregaNova.aspx" target="iframe_a" class="w3-bar-item w3-button"><i class="fa fa-motorcycle" aria-hidden="true"></i>&nbsp;&nbsp;Novo Pedido</a>
            ...
            <a href="Default.aspx" target="_parent" class="w3-bar-item w3-button"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Sair</a>
        </section>
    </div>
